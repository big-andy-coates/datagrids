...
* Coherence.jar. v12.1.3 at the time of writing.
* A environment variable called JAVA_3RD_PARTY_LIBS such that the coherence.jar can be found at JAVA_3RD_PARTY_LIBS/coherence/12.1.3.0.0/coherence.jar
